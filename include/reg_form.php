...
$Db_objects->compid=rand().trim($_POST['rollnum']);$Db_objects->college=trim($_POST['college']);
$Db_objects->concern_depart=trim($_POST['depart']);
$Db_objects->roll_number=trim($_POST['rollnum']);$Db_objects->query=trim($_POST['query']);$Db_objects->otp=rand();
$Db_objects->sname=trim($_POST['sname']);$Db_objects->fname=trim($_POST['fname']);$Db_objects->cno=trim($_POST['contact']);
$Db_objects->branch=trim($_POST['branch']);$Db_objects->year=trim($_POST['year'])
;$Db_objects->cdtime=date('Y-m-d H:i:s');
...
$sdb_ftable_fields=db_objects::$db_stable_fields;
$sdb_ftable=db_objects::$db_stable;
$CheckUserId=$Db_objects->search_by_id($Db_objects->roll_number,$sdb_ftable);
if ($CheckUserId == 0)
	{
$Db_objects->create($sdb_ftable,$sdb_ftable_fields);
	}
$get_otp=$Db_objects->otp;
$msg="Dear%20student%20here%20is%20your%20OTP%20:%20$get_otp";
$call_data->send_sms($Db_objects->cno,$msg);
print $Db_objects->cno;print $msg;
//$session->for_otp($Db_objects->otp,$Db_objects->roll_number,$Db_objects->cno);
//$call_data->redirect("otp.php");
							}
