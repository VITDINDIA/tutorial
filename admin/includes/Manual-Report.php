 <div id="page-wrapper" style="width:120%;">
  ...
  <h4>Total Manual Leads</h4> 
  <?php if(isset($_POST['fdate']) or isset($_GET['fdate']))   { ?>
  <p>
  <a target="_new()" href="includes/Manually-Leads-Report.php?fdate=<?php if(isset($_POST['fdate'])){ print $_POST['fdate']; } 
  ...
  <img src="../img/exl.png" height="60px" width="60px"></a>
   ...
   <h4>From: <?php   if(isset($_POST['fdate'])){ print $call_data->date_format($_POST['fdate']); } else{ ?>  <?php print $call_data->date_format($_GET['fdate']); } ?>
   To: <?php    if(isset($_POST['fdate'])){  print $call_data->date_format($_POST['sdate']);}else{ ?>  <?php print $call_data->date_format($_GET['sdate']); } ?> </h4> 
  <?php                              } ?>         
               <table width="983" class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th width="103">Query</th>
                      ...
                      print $Db_objects->search_all(4,$Today,$_POST['fdate'],$_POST['sdate']);		
                                                    }  
                      else if(isset($_GET['fdate']))   { 
                   
                      print $Db_objects->search_all(4,$Today,$_GET['fdate'],$_GET['sdate']);
                 ...
                 echo"<script>location.href='index.php?id=Manual-Report&fdate=$Fdate&sdate=$Sdate';</script>";
                ...
                $senduid=$_POST['suid'];
                echo"<script>location.href='index.php?id=Manual-Report&fdate=$Fdate&sdate=$Sdate#$senduid';</script>";
